...
public class IngredientReadRepository : EfRepositoryBase<Ingredient>, IIngredientReadRepository
{
    public IngredientReadRepository(RecipesDbContext db) : base(db) { }
